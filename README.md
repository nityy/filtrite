...
| Link | Description  |
| ------ | ------|
| [Bromite Default](https://github.com/nityy/filtrite/releases/latest/download/bromite-default.dat) | Bromite [default filter list](https://github.com/bromite/filters), but generated by this tool |
| [Bromite Extended](https://github.com/nityy/filtrite/releases/latest/download/bromite-extended.dat) | The default list with additional annoyance blockers I use with [uBlock Origin](https://github.com/gorhill/uBlock) on Desktop |
| [German](https://github.com/xarantolus/nityy/releases/latest/download/german.dat) | The "Bromite Extended" list with additional region-specific blocklists for german sites |
| [Max](https://github.com/xarantolus/nityy/releases/latest/download/max.dat) | The "Bromite Extended" list with additional custom lists |
